package codegym.c10.minispring.logger;
...
public class Logger {
    ...
    @Before("execution(public * codegym.c10.minispring.service.impl.ComputerService.*(..))")
    ...
    @AfterReturning(value = "execution(public * codegym.c10.minispring.service.impl.ComputerService.*(..))", returning = "result")
